...
public final class CurrencyServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<CurrencyList,
      ExchangeRate> METHOD_GET_EXCHANGE_RATES =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING,
          generateFullMethodName(
              "currency.CurrencyService", "GetExchangeRates"),
          io.grpc.protobuf.ProtoUtils.marshaller(CurrencyList.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ExchangeRate.getDefaultInstance()));
  ...
  public static abstract class CurrencyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getExchangeRates(CurrencyList request,
  ...
  public static final class CurrencyServiceBlockingStub extends io.grpc.stub.AbstractStub<CurrencyServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<ExchangeRate> getExchangeRates(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EXCHANGE_RATES:
          serviceImpl.getExchangeRates((CurrencyList) request,
              (io.grpc.stub.StreamObserver<ExchangeRate>) responseObserver);
          break;
        default:
