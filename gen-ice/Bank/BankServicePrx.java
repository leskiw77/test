...
public interface BankServicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.concurrent.CompletableFuture<AccountPrx> createAccountAsync(PersonData personData, MoneyAmount monthIncome)
    {
        return _iceI_createAccountAsync(personData, monthIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> createAccountAsync(PersonData personData, MoneyAmount monthIncome, java.util.Map<String, String> context)
    {
        return _iceI_createAccountAsync(personData, monthIncome, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<AccountPrx> _iceI_createAccountAsync(PersonData iceP_personData, MoneyAmount iceP_monthIncome, java.util.Map<String, String> context, boolean sync)
    {
